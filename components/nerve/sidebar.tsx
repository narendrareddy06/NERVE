...
export function NerveSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-[220px] flex flex-col bg-white border-r border-slate-200 z-40">
      {/* Logo */}
      ...
      <div className="p-3 border-t border-slate-200">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs font-semibold text-[#0F172A] truncate group-hover:text-red-600">
              {displayName || "User"}
            </p>
            <p className="text-[10px] text-[#64748B] truncate group-hover:text-red-500">
